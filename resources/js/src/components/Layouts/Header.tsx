                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                                ...
                                button={<img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src={user && user.image ? `/storage/${user.image}` : '/assets/images/user-profile.jpg'} alt="userProfile" />}
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="rounded-md w-10 h-10 object-cover" src={user && user.image ? `/storage/${user.image}` : '/assets/images/user-profile.jpg'} alt="userProfile" />
                                            <div className="ltr:pl-4 rtl:pr-4 truncate">
                                                <h4 className="text-base">
                                                    {user ? user.full_name : 'full name'}
                                                    <span className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">Active</span>
                                                </h4>
                                    ...
                                    {/*    </Link>*/}
                                    {/*</li>*/}
                                    <li className="border-t border-white-light dark:border-white-light/10 hover:bg-blue-50">
                                        <button onClick={handleLogout} className="text-danger py-3 flex ml-0.5 cursor-pointer">
                                            <svg className="ltr:mr-2 rtl:ml-2 rotate-90 shrink-0" width="18"
